...
export default function ArtworkReport({ open, handleModal }) {
  // gm : states ↓
            ...
            <Grid item className={Style.bodyModal}>
              ...
              >
                ...
                <Grid item>
                  <Grid container>
                    <Grid item>
                      <img src={ImagePng.src} className={Style.ImgRep} />
                    </Grid>
                    <Grid item className={Style.P_RepName}>
              ...
              <Grid item className={Style.P_RepBtn}>
                ...
                <Button
                  className={
                    ReportTopic === "CV" ? Style.RepBtnSelected : Style.RepBtn
                  }
                  onClick={() => setReportTopic("CV")}
                >
                  CV
                </Button>
                <Button
                  className={
                    ReportTopic === "Claim Profile"
                      ? Style.RepBtnSelected
                      : Style.RepBtn
                  }
                  onClick={() => setReportTopic("Claim Profile")}
                >
                  Claim Profile
                </Button>
              </Grid>
              ...
              <Grid item className={Style.ClaimPro}>Are you “Ester Howard”, <span className="link">Claim your profile?</span></Grid>
            </Grid>
