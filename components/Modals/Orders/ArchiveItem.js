      ...
      >
        <Fade in={open}>
          <Grid item className={style.wrapper_modal440}>
            ...
            {/* body */}
            <Grid item className={style.bodyModal} style={{ lineHeight: '1.7' }}>
              {
                !IsArchive ? (
                  <>
                    Your order is confired, you can only archive it.
                    Are you sure you
                    want to archive <span style={{ whiteSpace: 'nowrap' }}>“Order {Name}”</span> ?
                  </>
                ) : (
                  <>
                    Are you sure you
                    want to unarchive <span style={{ whiteSpace: 'nowrap' }}>“Order {Name}”</span> ?
                  </>
                )
              }
            ...
            <Grid item className={style.p_buttonModal}>
              ...
              >
                Yes, {IsArchive ? "unarchive" : "Archive"}
              </Button>
            </Grid>
          </Grid>
        </Fade>
