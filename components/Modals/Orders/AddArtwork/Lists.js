...
import ListsArtworks from "./ListsArtworks";

// gm : components ↓

export default function Lists({ open, handleModal }) {
  // gm : states ↓
  const [ModalListArtwork, setModalListArtwork] = useState(false)
  ...
  return (
    <Grid item>
        ...
        <Fade in={open}>
          <Grid item className={style.wrapper_modal750}>
            ...
            <Grid item className={style.bodyModal}>
              {/* Item */}
              <Item setModal={setModalListArtwork} title="List 001" NumArtwork="25"/>
              <Item setModal={setModalListArtwork} title="List 001" NumArtwork="25"/>
              <Item setModal={setModalListArtwork} title="List 001" NumArtwork="25"/>
              <Item setModal={setModalListArtwork} title="List 001" NumArtwork="25"/>
              <Item setModal={setModalListArtwork} title="List 001" NumArtwork="25"/>
      ...
      <ListsArtworks open={ModalListArtwork} handleModal={()=>setModalListArtwork(false)}/>
    </Grid>
  );
}
