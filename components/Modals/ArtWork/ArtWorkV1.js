...
export default function ArtWorkV1({
  ...
  const [ShowingImage, setShowingImage] = useState("/images/artwork detail.png");
  //  End -------------------------------------------------------------------------------------------------------------
  ...
  useEffect(() => {
    if (Medias?.length >= 1) {
      if (Minting === true) {
        setShowingImage(BASE_Image_Url + Medias[0]?.fileUrl);
      } else {
        setShowingImage(BASE_Image_Url + Medias[0]?.fileUrl);
      }
    } else {
                                  ...
                                  >
                                    ...
                                    >
                                      <Button
                                        ...
                                        fullWidth
                                        color={
                                          Data?.isProofNedded === false || Data?.isUserVerified === true || Minting === true
                                            ? "primary"
                                            : "default"
                                        }
                                        variant={
                                        ...
                                        disabled={Data?.isProofNedded !== false || Data?.isUserVerified !== true || Minting === true}
                                      >
                                        {
                                          Minting === true ? (
                                            <>
