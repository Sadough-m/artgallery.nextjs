...
export default function ProfessionalAppointments({
    ...
    useEffect(() => {
        if (LocalData?.length) {
            ...
            setHaveData(false);
            localStorage.setItem("Step2-ProfessionalAppointments", '[]')
        }
    }, [LocalData]);
    ...
    useEffect(() => {
        localStorage.setItem("Step2-ProfessionalAppointments", JSON.stringify(LocalData));
    }, [LocalData]);
                    ...
                    <InputForm
                        ...
                        schema={Joi.string()
                            ...
                            .messages({
                                ...
                                "any.required": `biography refrence is required`,
                            })}
