...
// good man : components ↓
import EditCv from '../../../../components/Modals/CV/EditProfessionalOrganizationsCv';
...
export default function Items({ setLocalData, LocalData, Data, titleListIsOpen, ItemId }) {
    ...
    const GET_ADDED_DATA = JSON.parse(typeof window !== "undefined" ? localStorage.getItem("Step2-Professional-Organizations") || '[]' : '[]');
    ...
    const handleDeleteItem = () => {
        ...
        localStorage.setItem("Step2-Professional-Organizations", JSON.stringify(GET_ADDED_DATA.filter(Item => Item?.id !== Data?.id)));
        toast.success("Your item Deleted successfully");
        setPOiataEdited(true);
        handleCloseRemoveCV();
