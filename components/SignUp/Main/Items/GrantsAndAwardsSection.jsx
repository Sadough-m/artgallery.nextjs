...
// good man : components ↓
import Items from "./GrantsAndAwardsItems";

// good man : states ↓
export default function Section({ setLocalData, title, LocalData, haveData, SelectInputData }) {
  // mrx : states ↓
          ...
          >
            <Grid item className={signUpStyle.w_95}>
              <Grid container alignItems="center">
                {Data?.map((item, index) => (
                  <Items key={index} setLocalData={setLocalData} LocalData={LocalData} SelectInputData={SelectInputData} Data={item} ItemId={index} titleListIsOpen={titleListIsOpen} />
                ))}
              </Grid>
            </Grid>
          </Grid>
