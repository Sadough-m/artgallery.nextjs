...
// good man : components ↓
import EditCv from '../../../../components/Modals/CV/EditBilbiographyCv';
...
export default function Items({ setLocalData, LocalData, Data, titleListIsOpen, ItemId }) {
    ...
    const GET_ADDED_DATA = JSON.parse(typeof window !== "undefined" ? localStorage.getItem("Step2-Bilbiography") || '[]' : '[]');
    ...
    const handleDeleteItem = () => {
        ...
        localStorage.setItem("Step2-Bilbiography", JSON.stringify(GET_ADDED_DATA.filter(Item => Item?.id !== Data?.id)));
        toast.success("Your item Deleted successfully");
        setBGDataEdited(true);
        handleCloseRemoveCV();
