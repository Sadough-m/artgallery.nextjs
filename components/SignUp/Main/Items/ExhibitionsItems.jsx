...
// good man : components ↓
import EditCv from '../../../../components/Modals/CV/EditExhibitionsCv';
...
export default function Items({ CountrySelectInputData, setLocalData, LocalData, SelectInputData, Data, titleListIsOpen, ItemId }) {
    ...
    const handleDeleteItem = () => {
        ...
        localStorage.setItem("Step2-Exhibitions", JSON.stringify(GET_ADDED_DATA.filter(Item => Item?.id !== Data?.id)));
        toast.success("Your item Deleted successfully");
        setSEDataEdited(true);
        handleCloseRemoveCV();
    ...
    return (
        ...
        >
            ...
            <EditCv
                ...
                Data={Data}
                openModal={modalCv}
                handleCloseModal={() => handleCloseEditCv()}
            />
