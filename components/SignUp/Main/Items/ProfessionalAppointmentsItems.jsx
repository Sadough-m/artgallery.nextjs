...
// good man : components ↓
import EditCv from '../../../../components/Modals/CV/EditProfessionalAppointmentsCv';
...
export default function Items({ CountrySelectInputData, setLocalData, LocalData, SelectInputData, Data, titleListIsOpen, ItemId }) {
    ...
    const GET_ADDED_DATA = JSON.parse(typeof window !== "undefined" ? localStorage.getItem("Step2-ProfessionalAppointments") || '[]' : '[]');
    ...
    const handleDeleteItem = () => {
        ...
        localStorage.setItem("Step2-ProfessionalAppointments", JSON.stringify(GET_ADDED_DATA.filter(Item => Item?.id !== Data?.id)));
