...
export default function Bio() {
    ...
    const GET_ADDED_DATA = typeof window !== "undefined" ? localStorage.getItem("Add-Artist-Bio") : "";

    // mrx : local storage ↓
    // 
    // mrx : set local data for bio ↓
    const handleSetLocalBio = (e) => {
        localStorage.setItem("Add-Artist-Bio", bio);
    }

    useEffect(() => {
        setbio(GET_ADDED_DATA ? GET_ADDED_DATA : "");
    }, [])
