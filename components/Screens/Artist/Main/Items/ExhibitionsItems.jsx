...
// good man : components ↓
import EditCv from '../../../../../components/Modals/ArtistCV/EditExhibitionsCv';
...
export default function Items({ CountrySelectInputData, setLocalData, LocalData, SelectInputData, Data, titleListIsOpen, ItemId }) {
    ...
    const GET_ADDED_DATA = JSON.parse(typeof window !== "undefined" ? localStorage.getItem("Add-Artist-Exhibitions") || '[]' : '[]');
    ...
    const handleDeleteItem = () => {
        ...
        localStorage.setItem("Add-Artist-Exhibitions", JSON.stringify(GET_ADDED_DATA.filter(Item => Item?.id !== Data?.id)));
