...
// good man : components ↓
import EditCv from '../../../../../components/Modals/ArtistCV/EditProfessionalServiceCv';
...
export default function Items({ CountrySelectInputData, setLocalData, LocalData, SelectInputData, Data, titleListIsOpen, ItemId }) {
    ...
    const handleDeleteItem = () => {
        ...
        localStorage.setItem("Add-Artist-Professional-Service", JSON.stringify(GET_ADDED_DATA.filter(Item => Item?.id !== Data?.id)));
