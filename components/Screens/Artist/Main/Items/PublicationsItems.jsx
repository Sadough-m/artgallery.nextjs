...
// good man : components ↓
import EditCv from '../../../../../components/Modals/ArtistCV/EditPublicationsCv';
...
export default function Items({ setLocalData, LocalData, Data, titleListIsOpen, ItemId }) {
    ...
    const GET_ADDED_DATA = JSON.parse(typeof window !== "undefined" ? localStorage.getItem("Add-Artist-Publications") || '[]' : '[]');
    ...
    const handleDeleteItem = () => {
        ...
        localStorage.setItem("Add-Artist-Publications", JSON.stringify(GET_ADDED_DATA.filter(Item => Item?.id !== Data?.id)));
