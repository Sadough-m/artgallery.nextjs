...
// good man : components ↓
import EditCv from '../../../../../components/Modals/ArtistCV/EditCollectionsCv';
...
export default function Items({ CountrySelectInputData, setLocalData, LocalData, SelectInputData, Data, titleListIsOpen, ItemId }) {
    ...
    const handleDeleteItem = () => {
        ...
        localStorage.setItem("Add-Artist-Collections", JSON.stringify(GET_ADDED_DATA.filter(Item => Item?.id !== Data?.id)));
