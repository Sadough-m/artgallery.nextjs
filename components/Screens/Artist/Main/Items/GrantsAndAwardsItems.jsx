...
// good man : components ↓
import EditCv from '../../../../../components/Modals/ArtistCV/EditGrantsAndAwardsCv';
...
export default function Items({ setLocalData, LocalData, SelectInputData, Data, titleListIsOpen, ItemId }) {
    ...
    const GET_ADDED_DATA = JSON.parse(typeof window !== "undefined" ? localStorage.getItem("Add-Artist-Grants-And-Awards") || '[]' : '[]');
    ...
    const handleDeleteItem = () => {
        ...
        localStorage.setItem("Add-Artist-Grants-And-Awards", JSON.stringify(GET_ADDED_DATA.filter(Item => Item?.id !== Data?.id)));
