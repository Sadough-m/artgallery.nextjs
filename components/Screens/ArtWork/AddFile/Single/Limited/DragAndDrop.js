...
export default function DragAndDrop({
    ...
    useEffect(() => {
        setItems({ left: Data });
        if (SignleItemId === "Reproduction") {
            localStorage.setItem("Reproduction-Media", JSON.stringify(Data));
        } else {
            localStorage.setItem("Original-Media", JSON.stringify(Data));
        }
    }, [Data])
    // End -------------------------------------------------------------------------------------------------------------------------
    ...
    // get main buttons by classification -------------------------------------------------------------------------------------------
    const getItems = () => {
        return (
            <>
