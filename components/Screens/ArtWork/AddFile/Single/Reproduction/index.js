...
export default function AddFile({
    ...
    useEffect(() => {
        setNumberLenght(70 * parseInt(UploadingFileMedia?.length));
    }, [UploadingFileMedia])
            ...
            <section className="container">
                {
                    UploadingFileMedia?.length >= 1 &&
                        UploadingFileMedia?.filter(item => item?.classificationType === LocalClassificationID)?.length !== 0 ?
                        (
                                                ...
                                                style={{
                                                    ...
                                                    height: width > 960 ?
                                                        LocalClassificationID === 1 ?
                                                            Uploading ? handleGetHeightDesktop() : handleGetHeightDesktopLimited()
                                                            :
                                                            LocalClassificationID === 2 ? Uploading ? handleGetHeightDesktop() : handleGetHeightDesktopLimited() : handleGetHeightDesktop()
                                                        : NumberLenght
                                                }}
                                            >
                                                {
