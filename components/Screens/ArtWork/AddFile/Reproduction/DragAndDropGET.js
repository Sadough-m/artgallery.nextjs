...
export default function DragAndDrop({
    ...
    const handleMakethemeSame = () => {
        ...
        // )
        handleMergeMediaSame(Data)
        // setUploadingFileMedia(
        //     Data &&
        //     Data?.map((Item) => {
        //         return { ...Item, LimitedSt: 0 };
        //     })
        // );
    }
    // End -------------------------------------------------------------------------------------------------------------------------

    const handleMergeMediaSame = (Data) => {
        setOriginalMediaData({
            "editionNumber": 0,
            "mediaSort": JSON.stringify(Data?.filter((item) => parseInt(item?.LimitedSt) !== 1)?.map((item) => ({
            ...
            "medias": Data?.filter((item) => parseInt(item?.LimitedSt) !== 1)?.map((item) => ({
                "fileUrl": item?.fullPath,
                "caption": item?.caption,
                "type": item?.type,
                "id": item?.id,
    ...
    useEffect(() => {
        handleMergeMedia(Data)
        setItems({ Original: Data?.filter(item => item?.LimitedSt == 0), Reproduction: Data?.filter(item => parseInt(item?.LimitedSt) === 1) });
    }, [Data])
    // End -------------------------------------------------------------------------------------------------------------------------
    ...
    const handleMergeLastMediaForReproduction = () => {
        ...
        setAllMediaData(ReproductionAllMediaData);
    }
    // End -------------------------------------------------------------------------------------------------------------------------

    const handleMergeMedia = (Data) => {
        setOriginalMediaData({
            "editionNumber": 0,
            "mediaSort": JSON.stringify(Data?.filter((item) => item?.LimitedSt === 0)?.map((item) => ({
                "fileUrl": item?.fullPath,
                "caption": item?.caption,
                "type": item?.type,
                "limitedSt": item?.limitedSt,
            ...
            "medias": Data?.filter((item) => item?.LimitedSt === 0)?.map((item) => ({
                "fileUrl": item?.fullPath,
                "caption": item?.caption,
                "type": item?.type,
                "id": item?.id,
        ...
        setReproductionMediaData({
            "editionNumber": 1,
            "mediaSort": JSON.stringify(Data?.filter((item) => item?.LimitedSt === 1)?.map((item) => ({
                "fileUrl": item?.fullPath,
                "caption": item?.caption,
                "type": item?.type,
                "id": item?.id,
            ...
            "medias": Data?.filter((item) => item?.LimitedSt === 1)?.map((item) => ({
                "fileUrl": item?.fullPath,
                "caption": item?.caption,
                "type": item?.type,
                "id": item?.id,
