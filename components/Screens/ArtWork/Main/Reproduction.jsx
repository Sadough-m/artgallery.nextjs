...
export default function Measurment({ is_inside = false, haveTitle = true, SelectInputData }) {
  // mrx : context
  const { ShowenReproduction, SelectedTypeID, setShowenReproduction, ReproductionSectionData, setReproductionSectionData } = useContext(Context);
