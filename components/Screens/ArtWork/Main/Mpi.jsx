...
export default function Mpi({ Data, SelectInputData, setLocalData, LocalData }) {
  ...
  return (
    <Grid item>
      <Grid
        container
        direction="column"
        className={ArtFlowStyle.title2Editions6}
      >
        <Grid item className={`${ArtFlowStyle.title3}`} style={{marginTop:'20px'}}>
          Measurment
        </Grid>
