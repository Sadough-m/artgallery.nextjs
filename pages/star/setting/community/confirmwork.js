...
import ErrorSvg from "../../../../public/images/icons/ErrorInfo.svg";
...
import TableArtwork from "../../../../components/Screens/Star/Setting/Table";
      ...
      <Grid container className={Style.WrapperCommunity}>
        ...
        <Grid item className={Style.RightSide_Com}>
          <Grid item className={Style.AccountStatuse}>
            <Grid container>
              <Grid item className={Style.ColseIcon}>
              ...
              <Grid item className={Style.RightChoose}>
                <Grid
                  ...
                  alignItems="center"
                  className={Style.P_NotRec}
                >
                  <Grid item className={Style.DontRecText}>
                    Don’t recognize any of these Information ?
                  </Grid>
                  <Grid item className={Style.P_NotRecBtn}>
                    <Button
                      color="secondary"
                      variant="contained"
                      startIcon={<img src={ErrorSvg.src} />}
                      className={Style.NotRecBtn}
                    >
                      Not recognized
                    </Button>
                  </Grid>
