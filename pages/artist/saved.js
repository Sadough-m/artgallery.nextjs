        ...
        >
          <Grid item className={ArtistStyle.P_artistNav}>
            <Grid container spacing={3} direction="column">
              ...
              {/* <Grid item className={ArtistStyle.Saved}>
                <Grid
                  container
                  spacing={1}
                  alignItems="center"
                  className={ArtistStyle.P_savedContact}
                >
                  <Grid item>
                    <IconButton size="small" onClick={() => { setSaved(false); router.push("/artist/list"); }}>
                      <Image src={close} />
                    </IconButton>
                  </Grid>
                  <Grid item className={ArtistStyle.savedContact}>
                    Saved artists
                  </Grid>
                </Grid>
              </Grid> */}
...
export default withAuth(ArtistsList1);
